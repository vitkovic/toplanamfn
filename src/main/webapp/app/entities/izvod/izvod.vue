<template>
    <div>
        <h2 id="page-heading">
            <span v-text="$t('toplanaApp.izvod.home.title')" id="izvod-heading">Izvods</span>
            <router-link :to="{name: 'IzvodCreate'}" tag="button" id="jh-create-entity" class="btn btn-primary float-right jh-create-entity create-izvod">
                <font-awesome-icon icon="plus"></font-awesome-icon>
                <span  v-text="$t('toplanaApp.izvod.home.createLabel')">
                    Create a new Izvod
                </span>
            </router-link>
        </h2>
        ...
        <div class="alert alert-warning" v-if="!isFetching && izvods && izvods.length === 0">
            <span v-text="$t('toplanaApp.izvod.home.notFound')">No izvods found</span>
        </div>
        <div class="table-responsive" v-if="izvods && izvods.length > 0">
            <table class="table table-striped">
                ...
                <tr v-for="izvod in izvods"
                    ...
                    <td class="text-right">
                        <div class="btn-group">
                            <router-link :to="{name: 'IzvodView', params: {izvodId: izvod.id}}" tag="button" class="btn btn-info btn-sm details">
...
<script lang="ts" src="./izvod.component.ts">
</script>
