    ...
    <div class="row ">
        <div class="col-8">
            <form name="editForm" role="form" novalidate v-on:submit.prevent="save()" >
                <h2  id="toplanaApp.transakcija.zaduzenje" v-text="$t('toplanaApp.transakcija.zaduzenje')"></h2>
                ...
                <div class="row" style="margin-top:20px;margin-bottom:20px">
                    ...
                    <div class="col-6">
                        <input type="number" class="form-control" name="iznos" id="iznos" required
                            v-model="transakcija.duguje" 
                            :class="{'valid': !$v.transakcija.duguje.$invalid, 'invalid': $v.transakcija.duguje.$invalid }"
                            />
                    </div>
                </div>
...
<script lang="ts" src="./transakcija-zaduzenje.component.ts">
</script>
