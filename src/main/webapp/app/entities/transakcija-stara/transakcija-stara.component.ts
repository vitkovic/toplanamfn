...
export default class TransakcijaStara extends mixins(AlertMixin) {
  ...
  public mounted(): void {
    this.retrieveAllTransakcijaStaras();
  }
  ...
  public retrieveAllTransakcijaStaras(): void {
  ...
  public prepareRemove(instance: ITransakcijaStara): void {
  ...
  public removeTransakcijaStara(): void {
    this.transakcijaStaraService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('toplanaApp.transakcijaStara.deleted', { param: this.removeId });
